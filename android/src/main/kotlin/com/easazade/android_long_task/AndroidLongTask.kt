...
class AndroidLongTask(private val activity: FlutterActivity, private val binaryMessenger: BinaryMessenger) {
    ...
    private val REQUEST_IGNORING_BATTERY_OPTIMIZATION = "REQUEST_IGNORING_BATTERY_OPTIMIZATION"
    private val IGNORE_BATTERY_OPTIMIZATION_SETTINGS = "IGNORE_BATTERY_OPTIMIZATION_SETTINGS"
    private val IS_IGNORING_BATTERY_OPTIMIZATION = "IS_IGNORING_BATTERY_OPTIMIZATION"
    ...
    private fun isIgnoringBatteryOptimization(): Boolean {
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M)
            (activity.context.getSystemService(POWER_SERVICE) as PowerManager).isIgnoringBatteryOptimizations(activity.packageName)
        else false
    }

    private fun requestIgnoringBatteryOptimization() {
    ...
    private fun gotoIgnoreBatteryOptimizationSettings() {
